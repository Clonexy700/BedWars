...
import com.clonexy700.bedwars.merchant.ReflectionUtils.OBCCraftItemStack;
import org.bukkit.inventory.ItemStack;

public class MerchantOffer extends ReflectionUtils {
    ...
    protected NMSMerchantRecipe getHandle() {
        ...
        if (this.items[1] == null)
            nms = new NMSMerchantRecipe(OBCCraftItemStack.asNMSCopy(this.items[0]), ReflectionUtils.OBCCraftItemStack.asNMSCopy(this.items[2]));
        else
